 ...
 */
class Query extends \dv\SSW2014Bundle\Entity\Query implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'label', 'query', 'created_at', 'updated_at');
        }
