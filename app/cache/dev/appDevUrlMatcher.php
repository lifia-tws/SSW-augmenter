...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/query')) {
            ...
            // query_one
            if (preg_match('#^/query/(?P<id>[^/\\.]++)\\.json$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'query_one')), array (  '_controller' => 'dv\\SSW2014Bundle\\Controller\\QueryController::oneAction',));
            }
