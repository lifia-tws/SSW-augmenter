...
class CategoryController extends Controller
{
  public function likeAction(Request $request)
  {
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('dvSSW2014Bundle:Category')->findAll();

        return $this->render('dvSSW2014Bundle:Category:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('dvSSW2014Bundle:Category:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('dvSSW2014Bundle:Category')->find($id);
        ...
        return $this->render('dvSSW2014Bundle:Category:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('dvSSW2014Bundle:Category:edit.html.twig', array(
            'entity'      => $entity,
